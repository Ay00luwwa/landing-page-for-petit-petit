...
import { Home, Mail, Phone, MapPin, ArrowUp, ChevronDown } from "lucide-react"
...
const propertyTypes = [
  ...
  { name: "Private Properties", href: "/coming-soon" },
  { name: "Airbnb", href: "/coming-soon" },
]

const locations = ["Victoria Island", "Ikoyi", "Lekki", "Banana Island", "Eko Atlantic"]

const socialLinks = [
  { icon: faFacebook, href: "https://facebook.com/petitpetitenterprise", label: "Facebook" },
  { icon: faTwitter, href: "https://x.com/petitpetit_ent", label: "X (Twitter)" },
  { icon: faInstagram, href: "https://instagram.com/petitpetitenterprise", label: "Instagram" },
  { icon: faTiktok, href: "https://tiktok.com/@petitpetitenterprise", label: "TikTok" },
]
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:petitpetitenterprise@gmail.com"
                  className="text-primary-foreground/80 text-sm hover:text-gold transition-colors"
                >
...
// import { useState } from "react"
// import { Home, Facebook, Twitter, Instagram, Share2, Mail, Phone, MapPin, ArrowUp, ChevronDown } from "lucide-react"
// import { Button } from "@/components/ui/button"
// import Link from "next/link"
...
//   { icon: Twitter, href: "x.com/petitpetit_ent", label: "Twitter" },
//   { icon: Instagram, href: "instagram.com/petitpetitenterprise", label: "Instagram" },
//   { icon: faTiktok, href: "tiktok.com/petitpetitenterprise", label: "TikTok" },
// ]
